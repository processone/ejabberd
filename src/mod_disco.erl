...
-export([start/2,
         stop/1,
         reload/3,
         process_local_iq_items/1,
         process_local_iq_info/1,
         get_local_identity/5,
         get_local_features/5,
         get_local_services/5,
         process_sm_iq_items/1,
         process_sm_iq_info/1,
         get_sm_identity/5,
         get_sm_features/5,
         get_sm_items/5,
         get_info/5,
...
-spec get_local_identity([identity()],
                         jid(),
                         jid(),
                         binary(),
                         binary()) -> [identity()].
...
get_local_features({error, _Error} = Acc,
                   _From,
                   _To,
                   _Node,
                   _Lang) ->
...
get_local_services({error, _Error} = Acc,
                   _From,
                   _To,
                   _Node,
                   _Lang) ->
...
get_local_services(Acc, _From, To, <<"">>, _Lang) ->
    ...
    {result,
     ...
     Items};
get_local_services({result, _} = Acc,
                   _From,
                   _To,
                   _Node,
                   _Lang) ->
