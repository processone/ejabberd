...
-record(state,
	{socket,
	 ...
	 pres_t = (?SETS):new() :: gb_set() | {pres_t, non_neg_integer()},
         pres_f = (?SETS):new() :: gb_set() | {pres_f, non_neg_integer()},
	 pres_a = (?SETS):new() :: gb_set() | {pres_a, non_neg_integer()},
	 pres_last :: xmlel(),
	 ...
	 oor_unread_users = (?SETS):new() :: gb_set(),
