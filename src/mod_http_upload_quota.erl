...
terminate(Reason, #state{server_host = ServerHost, timer = Timer}) ->
    ...
    ejabberd_hooks:delete(http_upload_slot_request,
                          ServerHost,
                          ?MODULE,
                          handle_slot_request,
                          50),
...
%% ejabberd_hooks callback.
%%--------------------------------------------------------------------
-spec handle_slot_request(allow | deny,
                          binary(),
                          jid(),
                          binary(),
                          non_neg_integer(),
...
%% Internal functions.
%%--------------------------------------------------------------------
-spec enforce_quota(file:filename_all(),
                    non_neg_integer(),
