...
-export([add_delay_info/3, add_delay_info/4,
         ...
         peach/2,
         format_exception/4,
         get_my_ipv4_address/0,
         get_my_ipv6_address/0,
         parse_ip_mask/1,
...
-spec ip_to_list(inet:ip_address() |
                 undefined |
...
ip_to_integer({IP1, IP2, IP3, IP4, IP5, IP6, IP7,
               IP8}) ->
    IP1 bsl 16 bor IP2 bsl 16 bor IP3 bsl 16 bor IP4 bsl 16 bor
    IP5 bsl 16 bor IP6 bsl 16 bor IP7 bsl 16 bor IP8.
