...
-export([make_result_iq_reply/1, make_error_reply/3,
	 ...
	 expr_to_term/1, term_to_expr/1, is_whitespace/1,
...
-spec is_whitespace(xmlel() | cdata()) -> true | false.
...
-spec remove_whitespaces_deeply(xmlel() | [xmlel() | cdata()]) -> xmlel() | [xmlel() | cdata()].
