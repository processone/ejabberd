...
-define(DEFAULT_REALNAME, <<"Usuario del ChatMovil">>).
...
get_realname(ServerHost) ->
	Result = gen_mod:get_module_opt(ServerHost, ?MODULE, realname, fun iolist_to_binary/1, ?DEFAULT_REALNAME),
	Result.

get_webirc_password(ServerHost) ->
	Result = gen_mod:get_module_opt(ServerHost, ?MODULE, webirc_password, fun iolist_to_binary/1, ?DEFAULT_WEBIRC_PASSWORD),
	Result.
