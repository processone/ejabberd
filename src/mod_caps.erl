    ...
    lists:foldl(
      fun(SubNode, Acc) ->
              ...
              Res = case use_cache(Mod, Host) of
                        true ->
                            ets_cache:lookup(caps_features_cache,
                                             NodePair,
...
c2s_presence_in(C2SState,
    ...
    ToSelf = (From#jid.luser == To#jid.luser) andalso
    ...
    case Operation of
        ...
        insert ->
            ...
            NewRs = case gb_trees:lookup(LFrom, Rs) of
                        ...
                        _ ->
                            ejabberd_hooks:run(caps_update,
                                               To#jid.lserver,
                                               [From,
                                                To,
                                                get_features(To#jid.lserver, Caps)]),
...
init([Host | _]) ->
    ...
    Mod:init(Host, Opts),
    ejabberd_hooks:add(c2s_presence_in,
                       Host,
                       ?MODULE,
                       c2s_presence_in,
                       75),
...
terminate(_Reason, State) ->
    ...
    ejabberd_hooks:delete(c2s_presence_in,
                          Host,
                          ?MODULE,
                          c2s_presence_in,
                          75),
    ...
    ejabberd_hooks:delete(disco_local_identity,
                          ...
                          disco_identity,
                          75),
    ejabberd_hooks:delete(disco_info,
                          Host,
                          ?MODULE,
                          disco_info,
                          75),
...
compute_disco_hash(DiscoInfo, Algo) ->
    Concat = list_to_binary([concat_identities(DiscoInfo),
                             concat_features(DiscoInfo),
                             concat_info(DiscoInfo)]),
