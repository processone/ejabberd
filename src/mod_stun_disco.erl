...
register_hooks(Host) ->
    ejabberd_hooks:add(disco_local_features,
                       ...
                       50),
    ejabberd_hooks:add(stun_get_password,
                       ?MODULE,
                       stun_get_password,
                       50).
...
unregister_hooks(Host) ->
    ...
    case gen_mod:is_loaded_elsewhere(Host, ?MODULE) of
        false ->
            ejabberd_hooks:delete(stun_get_password,
                                  ?MODULE,
                                  stun_get_password,
                                  50);
        true ->
...
disco_local_features({result, OtherFeatures} = Acc,
                     From,
                     #jid{lserver = LServer},
                     <<"">>,
                     _Lang) ->
