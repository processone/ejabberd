...
This document explains how to use those container images:
...
Compare in detail both [images differences](#images-comparison).
...
if using `ejabberd` container image please go to the [ejabberd GitHub Issues](https://github.com/processone/ejabberd/issues?q=is%3Aopen+is%3Aissue+label%3APackaging%3AContainer),
if using `ecs` container image please go to the [docker-ejabberd GitHub Issues](https://github.com/processone/docker-ejabberd/issues).
...
| Built for             | stable releases and <br /> `master` branch | stable releases |
| Architectures         | `linux/amd64` and <br /> `linux/arm64` | `linux/amd64` |
| Software              | Alpine 3.19, <br /> Erlang/OTP 27.2, <br /> Elixir 1.18.1 | Alpine 3.19, <br /> Erlang/OTP 26.2, <br /> Elixir 1.15.7 |
| Published in          | [ghcr.io/processone/ejabberd](https://github.com/processone/ejabberd/pkgs/container/ejabberd) | [docker.io/ejabberd/ecs](https://hub.docker.com/r/ejabberd/ecs/) and <br /> [ghcr.io/processone/ecs](https://github.com/processone/docker-ejabberd/pkgs/container/ecs) |
...
| [`EJABBERD_MACRO_ADMIN`](#register-admin-account) | Grants admin rights :orange_circle: <br /> (default `admin@localhost`) <br /> | Hardcoded `admin@localhost` |
| [`REGISTER_ADMIN_PASSWORD`](#register-admin-account) | Register admin account :orange_circle: | not registered |
| `CTL_OVER_HTTP`       | enabled :orange_circle: | enabled :orange_circle: |
