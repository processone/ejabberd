...
Note that query timeout is hardcoded to 5 seconds for the \modsharedrosterldap{} module.
...
See section~\ref{msrlconfigroster} on how they are used during roster retrieval.
...
\makesubsubsection{msrlcacheparams}{Cache parameters}
...
\begin{description}
 ...
 fresh after retrieval. 300 by default.
 ...
 Maximum number of user items the cache will hold. 1000 by default.

 \titem{{\tt ldap\_group\_cache\_size}}
 Maximum number of group items the cache will hold. 1000 by default.
\end{description}
